...
export default function UserMenu() {
    ...
    return (
        <React.Fragment>
            <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center', margin: '0px' }}>
                <IconButton
                    disableRipple
                    onClick={handleClick}
                ...
                >
                    <Avatar sx={{ width: 32, height: 32 }} className={classes.avatar}>{user.name ? user.name[0].toUpperCase() : "U"}</Avatar>
                </IconButton>
            </Box>
            <Menu
                anchorEl={anchorEl}
