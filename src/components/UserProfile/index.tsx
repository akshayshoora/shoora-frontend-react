...
export default function EditProfile() {
  ...
  const loadingMessage = updatingUser ? "Updating User Profile..." : "";
  ...
  return (
    <Box className={classes.positionRelative}>
      ...
      <PageLoading open={updatingUser} loadingMessage={loadingMessage} />
      ...
      <Box className={classes.headingWrapper}>
        <Box className={classes.headingContent}>
          ...
          <Typography fontSize={24}>Edit Profile Information</Typography>
        </Box>
      </Box>
